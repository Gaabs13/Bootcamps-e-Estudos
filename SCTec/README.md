...
O SCTEC é o maior programa gratuito de qualificação tecnológica e capacitação em Inteligência Artificial do Governo de Santa Catarina, em parceria com o SENAI/SC.

A iniciativa oferece jornadas flexíveis e gratuitas voltadas tanto para iniciantes quanto para profissionais em busca de aperfeiçoamento técnico.
...
Este repositório tem como finalidade documentar a evolução ao longo da trilha, servindo como base de aprendizado contínuo e registro prático das atividades desenvolvidas.
